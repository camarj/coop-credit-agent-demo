...
export async function PersistedView({ applicationId: id, states }: PersistedViewProps) {
  ...
  // Display version excludes orchestrator-owned terminal markers (saga,
  // pipeline_failure). Operators want to see the latest agent contribution,
  // not "v2: __pipeline_failure".
